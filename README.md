...
| ![GitHub logomark] [GitHub]         | As a cloud-based service that helps us store and manage our code, and track and control changes to the code. We also want to utilize all of its [features] to make our project transparent and open-source. |
